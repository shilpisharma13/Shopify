        ...
        <div className='flex shadow-md my-10'>
          ...
          <div id='summary' className='w-1/4 px-8 py-10'>
            ...
            <div className='border-t mt-8'>
              ...
              <button className='flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-black border border-transparent rounded-md shadow-sm hover:bg-gray-800'>
                Checkout
              </button>
            </div>
          </div>
